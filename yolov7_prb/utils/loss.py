...
class ComputeLoss:
    ...
    def __call__(self, p, targets):  # predictions, targets, model
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            ### ADD NWD LOSS (NIOU) in ComputeLoss ### START
            ...
            ### ADD NWD LOSS (NIOU)in ComputeLoss ### END
...
class ComputeLossOTA:
    ...
    def __call__(self, p, targets, imgs):  # predictions, targets, model
        ...
        ###  ADD NWD LOSS (NIOU) in ComputeLossOTA ### START
                ...
                iou = (iou.detach() * iou_ratio + nwd.detach() * (1 - iou_ratio)).clamp(0, 1).type(tobj.dtype)
                tobj[b, a, gj, gi] = (1.0 - self.gr) + self.gr * iou  # iou ratio
        ###  ADD NWD LOSS (NIOU) in ComputeLossOTA ### END 
...
#   use CPU for the build targets to reduce memory usage
#   ref: https://github.com/WongKinYiu/yolov7/blob/main/utils/loss.py
class ComputeLossOTA_CPU:
    # Compute losses
    def __init__(self, model, autobalance=False):
        super(ComputeLossOTA_CPU, self).__init__()
